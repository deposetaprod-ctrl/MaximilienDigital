...
const pages = [
  { path: "/", priority: 1 as const, changeFrequency: "monthly" as const, lastModified: "2026-09-20" },
  { path: "/application-web-sur-mesure", priority: 0.95 as const, changeFrequency: "weekly" as const, lastModified: "2026-09-20" },
  { path: "/application-mobile", priority: 0.95 as const, changeFrequency: "weekly" as const, lastModified: "2026-09-20" },
