...
import { Users, FileDown, BellRing, Lock, Star, ArrowRight } from "lucide-react";
      ...
      <main className="min-h-screen bg-background">
        ...
        <section className="relative px-4 py-20 md:py-32 overflow-hidden">
          <div className="max-w-5xl mx-auto text-center relative z-10">
            ...
            <motion.h1
              ...
              dangerouslySetInnerHTML={{ __html: t("portal_ec_h1") }}
            />
            ...
            <motion.p
              ...
              dangerouslySetInnerHTML={{ __html: t("portal_ec_intro") }}
            />
        ...
        <section className="px-4 py-20 bg-muted/30">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4" dangerouslySetInnerHTML={{ __html: t("portal_ec_approach_title") }} />
              <p className="text-muted-foreground text-lg max-w-3xl mx-auto" dangerouslySetInnerHTML={{ __html: t("portal_ec_approach_desc") }} />
            </div>
              ...
              {[
                {
                  ...
                  desc: t("portal_ec_li1")
                },
                {
                  icon: FileDown,
                  title: "Dépôt Ultra-Simple",
                  desc: t("portal_ec_li2")
                },
                {
                  icon: Lock,
                  title: "Sécurité & RGPD",
                  desc: t("portal_ec_li3")
                },
                {
                  icon: Star,
                  title: "Satisfaction Client",
                  desc: t("portal_ec_li4")
                }
              ].map((feature, i) => (
        ...
        <section className="px-4 py-24 text-center">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-foreground mb-12">Le Processus</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
               <div className="flex flex-col items-center">
                  ...
                  <h3 className="text-xl font-bold mb-2">{t("portal_ec_step1_title")}</h3>
                  <p className="text-muted-foreground">{t("portal_ec_step1_desc")}</p>
               </div>
               <div className="flex flex-col items-center">
                  ...
                  <h3 className="text-xl font-bold mb-2">{t("portal_ec_step2_title")}</h3>
                  <p className="text-muted-foreground">{t("portal_ec_step2_desc")}</p>
               </div>
               <div className="flex flex-col items-center">
                  ...
                  <h3 className="text-xl font-bold mb-2">{t("portal_ec_step3_title")}</h3>
                  <p className="text-muted-foreground">{t("portal_ec_step3_desc")}</p>
               </div>
            </div>
