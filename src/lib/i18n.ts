...
export const translations = {
  fr: {
    ...
    mobapp_hero_cta: "Recevoir ma maquette gratuite",

    mobapp_why_title: "Pourquoi créer une application mobile ?",
    mobapp_why_sub: "Offrez une expérience inégalée à vos utilisateurs et augmentez considérablement leur engagement grâce aux fonctionnalités natives.",
    mobapp_why_1_title: "Fidélisation Maximale",
    mobapp_why_1_desc: "Envoyez des notifications push directement sur l'écran d'accueil pour réengager vos utilisateurs à tout moment.",
    mobapp_why_2_title: "Expérience Premium",
    mobapp_why_2_desc: "Une fluidité exceptionnelle, des animations fluides et l'accès aux capteurs du téléphone (Caméra, GPS, Bluetooth).",
    mobapp_why_3_title: "Visibilité sur les Stores",
    mobapp_why_3_desc: "Profitez du trafic naturel de l'App Store et Google Play pour acquérir de nouveaux clients quotidiennement.",

    mobapp_strategy_title: "Notre Stratégie de Lancement Évolutive",
    mobapp_strategy_sub: "Chaque projet d'application mobile native est unique : nous adaptons cette approche en fonction de vos objectifs pour créer l'app mobile qui correspond parfaitement à votre activité.",
    mobapp_strat_1_title: "Le Lancement Rapide",
    mobapp_strat_1_sub: "(Web App / MVP)",
    mobapp_strat_1_desc: "On commence par une version accessible sur navigateur. C'est le moyen le plus rapide de tester votre idée et d'acquérir vos premiers clients en quelques semaines.",
    mobapp_strat_2_title: "L'Installation Simple",
    mobapp_strat_2_sub: "(PWA)",
    mobapp_strat_2_desc: "Votre site web se transforme en application installable d'un simple clic sur l'écran d'accueil du téléphone de vos clients, sans passer par les Stores.",
    mobapp_strat_3_title: "La Consécration",
    mobapp_strat_3_sub: "(App Store & Google Play)",
    mobapp_strat_3_desc: "Une fois le concept validé et rentable, nous publions officiellement votre application sur iOS et Android pour inspirer une confiance absolue.",

    mobapp_projects_title: "Exemples d'Applications Mobiles",
    mobapp_projects_sub: "Des applications iOS & Android conçues pour offrir la meilleure expérience utilisateur possible.",
    mobapp_proj_1_title: "Application E-Commerce",
    mobapp_proj_1_desc: "Boutique en ligne avec paiement intégré, notifications push de promotions et suivi de livraison en temps réel.",
    mobapp_proj_2_title: "Outil pour équipe sur le terrain",
    mobapp_proj_2_desc: "Application hors-ligne pour les techniciens, scan de QR codes, signature électronique et synchronisation Cloud.",
    mobapp_proj_3_title: "Réseau Social de Niche",
    mobapp_proj_3_desc: "Profils utilisateurs, messagerie instantanée, flux d'actualités et géolocalisation pour connecter une communauté.",
    mobapp_proj_4_title: "Application avec Agents IA",
    mobapp_proj_4_desc: "Intégration d'IA pour modération, suivi financier, envois d'upsell automatisés et SMS programmés, avec une base de données 100% RGPD.",

    mobapp_expertise_title: "Expertise Technique Mobile",
    mobapp_expertise_sub: "Développement multi-plateforme performant et intégration de fonctionnalités avancées.",
    mobapp_exp_1_title: "Code Unique (React Native / Flutter)",
    mobapp_exp_1_desc: "Je développe avec des technologies modernes permettant de créer <strong>une seule application compatible iOS et Android</strong> simultanément. Cela divise par deux les coûts et les temps de développement par rapport à du code natif séparé.",
    mobapp_exp_2_title: "Haute Performance & Hors-ligne",
    mobapp_exp_2_desc: "L'application est conçue pour fonctionner de manière fluide même avec une mauvaise connexion. Les données importantes peuvent être stockées localement (offline-first) pour garantir un accès ininterrompu à vos utilisateurs.",

    mobapp_final_title: "Prêt à lancer votre application mobile ?",
    mobapp_final_sub: "Décrivez votre projet, obtenez votre maquette gratuite et commençons à développer.",
    mobapp_final_cta: "Recevoir ma maquette",
    // WebApp Page
    webapp_hero_badge: "Création de Site Internet & Application Web",
    webapp_hero_title: "Créer un site internet premium",
    webapp_hero_title_gradient: "ou une Web App",
    webapp_hero_sub: "Que vous cherchiez un site internet vitrine de haute qualité ou une Web App complexe, lancez une plateforme responsive prête à générer des revenus dès le premier jour.",
    webapp_trust_code: "Code source livré",
    webapp_trust_mockup: "Maquette gratuite",
    webapp_trust_support: "Accompagnement A à Z",
    webapp_hero_cta: "Recevoir ma maquette gratuite",

    webapp_why_title: "Pourquoi commencer par une application web ?",
    webapp_why_sub: "L'approche la plus intelligente pour tester votre marché et générer vos premiers revenus sans attendre des mois de validation.",
    webapp_why_1_title: "Plus rapide à lancer",
    webapp_why_1_desc: "Pas de délai de validation par Apple ou Google. Votre application est en ligne dès qu'elle est prête.",
    webapp_why_2_title: "Accessible sans installation",
    webapp_why_2_desc: "Vos utilisateurs accèdent à votre service via une simple URL, depuis n'importe quel appareil (PC, Mac, iOS, Android).",
    webapp_why_3_title: "Plus simple à tester",
    webapp_why_3_desc: "Les mises à jour sont instantanées pour tous vos utilisateurs. Idéal pour itérer rapidement selon les retours.",

    webapp_strategy_title: "Notre Stratégie de Lancement Évolutive",
    webapp_strategy_sub: "Votre application web grandit avec votre activité. Nous commençons par l'essentiel, puis nous enrichissons selon vos besoins.",
    webapp_strat_1_title: "Le Lancement Rapide",
    webapp_strat_1_sub: "(Web App / MVP)",
    webapp_strat_1_desc: "On développe votre application web sur mesure, accessible depuis n'importe quel navigateur. C'est le moyen le plus rapide de valider votre idée et d'acquérir vos premiers clients.",
    webapp_strat_2_title: "L'Expérience Enrichie",
    webapp_strat_2_sub: "(PWA — optionnel)",
    webapp_strat_2_desc: "Si vous le souhaitez, votre application web se transforme en PWA : installable sur téléphone d'un simple clic, utilisable hors-ligne et capable d'envoyer des notifications.",
    webapp_strat_3_title: "L'Écosystème Complet",
    webapp_strat_3_sub: "(App Mobile — optionnel)",
    webapp_strat_3_desc: "Si c'est pertinent pour votre activité, nous ajoutons une application mobile native sur les Stores qui communique avec votre web app, pour offrir un écosystème complet à vos utilisateurs.",

    webapp_projects_title: "Exemples de projets",
    webapp_projects_sub: "Des outils métiers concrets, conçus pour automatiser des tâches complexes et faciliter la croissance.",
    webapp_proj_1_title: "Plateforme de suivi étudiant",
    webapp_proj_1_desc: "Planning, QCM, messagerie et espaces étudiants/tuteurs. Centralisation de toute l'expérience éducative.",
    webapp_proj_2_title: "Outil métier connecté par API",
    webapp_proj_2_desc: "Automatisation d’images et synchronisation API avec l'ERP pour accélérer les processus internes.",
    webapp_proj_3_title: "Application de mise en relation",
    webapp_proj_3_desc: "Profils, abonnements, carte interactive et notifications en temps réel pour connecter les utilisateurs.",

    webapp_expertise_title: "Expertise Technique Avancée",
    webapp_expertise_sub: "Des technologies de pointe pour rendre votre application SaaS intelligente, sécurisée et conforme.",
    webapp_exp_1_title: "Agent IA & Automatisation",
    webapp_exp_1_desc: "En tant que <strong>développeur spécialiste Agent IA</strong>, j'intègre des modèles d'Intelligence Artificielle au cœur de votre SaaS (LLMs, RAG). L'objectif : automatiser vos processus complexes et doter votre outil de capacités d'analyse avancées.",
    webapp_exp_2_title: "Architecte Logiciel Sécurisé",
    webapp_exp_2_desc: "L'architecture de votre application web est conçue pour évoluer sans faille de sécurité. De la gestion des rôles utilisateurs (RBAC) à l'isolation des données, la base technique est solide dès le premier jour.",

    webapp_final_title: "Prêt à tester votre idée de Web App ?",
    webapp_final_sub: "Demandez votre maquette gratuite et commençons à construire l'application qui transformera votre activité.",
    webapp_final_cta: "Recevoir ma maquette",
    // Navigation
    nav_home: "Accueil",
    nav_mobile: "Mobile",
    nav_saas: "SaaS",
    ...
    hero_form_branch_q: "Comment souhaitez-vous présenter votre projet ?",
    hero_form_branch_opt_upload: "J'ai un cahier des charges (Rapide)",
    hero_form_branch_opt_guide: "Je veux être guidé(e) étape par étape",
    hero_form_upload_q: "Uploadez votre cahier des charges",
    hero_form_upload_sub: "Formats acceptés : PDF, DOCX, XLSX (Max 100Mo).",
    hero_form_upload_btn: "Choisir un fichier",
    ...
    hero_form_step3_opt5: "Santé / Médical",
    hero_form_step3_opt6: "Autre",
    hero_form_step3_custom_ph: "Précisez votre secteur d'activité...",
    hero_form_step4_q: "Décrivez votre projet en quelques mots",
    hero_form_step4_sub: "Plus vous êtes précis, plus votre maquette sera fidèle à votre vision.",
    hero_form_step4_ph: "Ex : Je souhaite un tableau de bord pour mes boutiques avec des alertes de stock...",
    hero_form_step4_btn: "Continuer",

    hero_form_nda_btn: "🔒 Demander une clause de confidentialité",
    hero_form_nda_title: "Accord de Confidentialité",
    hero_form_nda_desc: "Entrez le nom de votre projet pour générer un accord de confidentialité pré-signé par Maximilien Digital.",
    hero_form_nda_ph: "Nom de votre projet",
    hero_form_nda_generate: "Télécharger mon NDA (PDF)",

    hero_form_step5_q: "Vos Données & Listing (Optionnel)",
    hero_form_step5_sub: "Avez-vous déjà un fichier avec vos données (Excel, Google Sheets) ? Collez votre lien de partage ici :",
    hero_form_step5_ph: "Lien vers votre Google Sheet, fichier Excel ou base de données...",
    ...
    portal_ec_tag: "Portail Client · Expertise Comptable",
    portal_ec_h1: "Divisez par 2 le temps de relance client.",
    portal_ec_intro: "Fini les mails qui se perdent et les clients qui oublient leurs pièces. Offrez à vos clients un espace de dépôt de documents sécurisé, ergonomique, et relancez-les automatiquement. Conçu par un ancien de la finance, pour les experts-comptables.",
    portal_ec_cta1: "Demander une maquette gratuite",
    portal_ec_li1: "Relances automatisées pour les documents manquants.",
    portal_ec_li2: "Dépôt de pièces simple via téléphone ou PC.",
    portal_ec_li3: "Architecture hautement sécurisée (RGPD).",
    portal_ec_li4: "Mesure de la satisfaction client (NPS) intégrée au portail.",
    portal_ec_approach_title: "La fin du casse-tête de la collecte",
    portal_ec_approach_desc: "La collecte des pièces est la première cause de perte de marge d'un cabinet. En automatisant cette étape avec un outil ultra-simple pour vos clients, vos collaborateurs peuvent enfin se concentrer sur la révision et le conseil.",
    portal_ec_step1_title: "1. Centralisation",
    portal_ec_step1_desc: "Un seul endroit pour que vos clients déposent factures, relevés bancaires et contrats.",
    portal_ec_step2_title: "2. Suivi en temps réel",
    portal_ec_step2_desc: "Tableau de bord côté cabinet pour voir d'un coup d'œil les dossiers incomplets.",
    portal_ec_step3_title: "3. Automatisation",
    portal_ec_step3_desc: "Des scripts envoient des rappels personnalisés aux clients en retard, sans intervention humaine.",

    // Logiciel Expert Comptable (CRM & Gestion)
    logiciel_ec_tag: "Outil Interne & CRM · Cabinets Comptables",
    logiciel_ec_h1: "Gérez votre cabinet, pas vos fichiers Excel.",
    logiciel_ec_intro: "Lettres de mission, onboarding de nouveaux clients, suivi des temps, gestion des tâches de révision... Développez un outil sur-mesure interconnecté à votre logiciel de production pour structurer la croissance de votre cabinet.",
    logiciel_ec_cta1: "Demander une maquette gratuite",
    logiciel_ec_li1: "CRM adapté au cycle de vente d'un cabinet.",
    logiciel_ec_li2: "Génération automatique des lettres de mission.",
    logiciel_ec_li3: "Suivi de l'avancement des tâches par collaborateur.",
    logiciel_ec_li4: "Connexion API avec vos outils (Cegid, MyUnisoft...).",
    logiciel_ec_approach_title: "Un logiciel qui s'adapte à VOS process",
    logiciel_ec_approach_desc: "Vous n'avez pas à tordre vos processus internes pour les faire rentrer dans un logiciel générique. Je développe la brique manquante qui centralise l'administratif de votre cabinet.",
    logiciel_ec_step1_title: "1. Cadrage métier",
    logiciel_ec_step1_desc: "Étant familier avec le milieu, nous allons droit au but sur vos besoins métiers (KYC, honoraires...).",
    logiciel_ec_step2_title: "2. Développement du sur-mesure",
    logiciel_ec_step2_desc: "Une interface claire pour suivre le statut de chaque dossier et de chaque prospect.",
    logiciel_ec_step3_title: "3. Interconnexion",
    logiciel_ec_step3_desc: "L'outil interne communique avec votre facturation et votre production comptable.",
  ...
  en: {
    // MobileApp Page
    mobapp_hero_badge: "Custom Mobile App Development",
    mobapp_hero_title: "Your mobile application,",
    mobapp_hero_title_gradient: "present in your clients' pocket",
    mobapp_hero_sub: "Launch a native iOS and Android application to retain your users, send push notifications, and inspire trust through your presence on the App Store and Google Play.",
    mobapp_trust_store: "App Store & Google Play Publishing",
    mobapp_trust_mockup: "Free mockup",
    mobapp_trust_code: "Source code delivered",
    mobapp_hero_cta: "Get my free mockup",

    mobapp_why_title: "Why build a mobile app?",
    mobapp_why_sub: "Offer an unparalleled experience to your users and significantly increase their engagement with native features.",
    mobapp_why_1_title: "Maximum Retention",
    mobapp_why_1_desc: "Send push notifications directly to the home screen to re-engage your users at any time.",
    mobapp_why_2_title: "Premium Experience",
    mobapp_why_2_desc: "Exceptional smoothness, fluid animations, and access to phone sensors (Camera, GPS, Bluetooth).",
    mobapp_why_3_title: "Visibility on Stores",
    mobapp_why_3_desc: "Take advantage of organic traffic from the App Store and Google Play to acquire new customers daily.",

    mobapp_strategy_title: "Our Scalable Launch Strategy",
    mobapp_strategy_sub: "Every native mobile app project is unique: we adapt this approach based on your goals to create the perfect mobile app for your business.",
    mobapp_strat_1_title: "The Quick Launch",
    mobapp_strat_1_sub: "(Web App / MVP)",
    mobapp_strat_1_desc: "We start with a browser-accessible version. It's the fastest way to test your idea and acquire your first clients in a few weeks.",
    mobapp_strat_2_title: "Simple Installation",
    mobapp_strat_2_sub: "(PWA)",
    mobapp_strat_2_desc: "Your website turns into an installable application with a single click on your clients' home screen, without going through the Stores.",
    mobapp_strat_3_title: "The Consecration",
    mobapp_strat_3_sub: "(App Store & Google Play)",
    mobapp_strat_3_desc: "Once the concept is validated and profitable, we officially publish your application on iOS and Android to inspire absolute trust.",

    mobapp_projects_title: "Mobile App Examples",
    mobapp_projects_sub: "iOS & Android applications designed to offer the best user experience possible.",
    mobapp_proj_1_title: "E-Commerce Application",
    mobapp_proj_1_desc: "Online store with integrated payment, promotional push notifications, and real-time delivery tracking.",
    mobapp_proj_2_title: "Field Team Tool",
    mobapp_proj_2_desc: "Offline app for technicians, QR code scanning, electronic signature, and Cloud synchronization.",
    mobapp_proj_3_title: "Niche Social Network",
    mobapp_proj_3_desc: "User profiles, instant messaging, news feeds, and geolocation to connect a community.",
    mobapp_proj_4_title: "App with AI Agents",
    mobapp_proj_4_desc: "AI integration for moderation, financial tracking, automated upsells, and scheduled SMS, with a 100% GDPR compliant database.",

    mobapp_expertise_title: "Mobile Technical Expertise",
    mobapp_expertise_sub: "High-performance cross-platform development and integration of advanced features.",
    mobapp_exp_1_title: "Single Codebase (React Native / Flutter)",
    mobapp_exp_1_desc: "I develop with modern technologies to create <strong>a single application compatible with iOS and Android</strong> simultaneously. This halves development costs and time compared to separate native code.",
    mobapp_exp_2_title: "High Performance & Offline",
    mobapp_exp_2_desc: "The app is designed to run smoothly even with a poor connection. Important data can be stored locally (offline-first) to ensure uninterrupted access for your users.",

    mobapp_final_title: "Ready to launch your mobile app?",
    mobapp_final_sub: "Describe your project, get your free mockup, and let's start developing.",
    mobapp_final_cta: "Get my mockup",
    // WebApp Page
    webapp_hero_badge: "Custom Web Application Development",
    webapp_hero_title: "Your custom web application,",
    webapp_hero_title_gradient: "ready to be tested quickly",
    webapp_hero_sub: "Launch a responsive application accessible on desktop, tablet, and mobile, without immediately going through the App Store or Google Play.",
    webapp_trust_code: "Source code delivered",
    webapp_trust_mockup: "Free mockup",
    webapp_trust_support: "End-to-end support",
    webapp_hero_cta: "Get my free mockup",

    webapp_why_title: "Why start with a web application?",
    webapp_why_sub: "The smartest approach to test your market and generate your first revenue without waiting months for validation.",
    webapp_why_1_title: "Faster to launch",
    webapp_why_1_desc: "No validation delay by Apple or Google. Your application is online as soon as it's ready.",
    webapp_why_2_title: "Accessible without installation",
    webapp_why_2_desc: "Your users access your service via a simple URL, from any device (PC, Mac, iOS, Android).",
    webapp_why_3_title: "Easier to test",
    webapp_why_3_desc: "Updates are instant for all your users. Ideal for iterating quickly based on feedback.",

    webapp_strategy_title: "Our Scalable Launch Strategy",
    webapp_strategy_sub: "Your web application grows with your business. We start with the essentials, then we enrich according to your needs.",
    webapp_strat_1_title: "The Quick Launch",
    webapp_strat_1_sub: "(Web App / MVP)",
    webapp_strat_1_desc: "We develop your custom web application, accessible from any browser. It's the fastest way to validate your idea and acquire your first clients.",
    webapp_strat_2_title: "The Enriched Experience",
    webapp_strat_2_sub: "(PWA — optional)",
    webapp_strat_2_desc: "If you wish, your web application transforms into a PWA: installable on a phone with a single click, usable offline, and capable of sending notifications.",
    webapp_strat_3_title: "The Complete Ecosystem",
    webapp_strat_3_sub: "(Mobile App — optional)",
    webapp_strat_3_desc: "If it's relevant to your business, we add a native mobile application on the Stores that communicates with your web app, to offer a complete ecosystem to your users.",

    webapp_projects_title: "Project examples",
    webapp_projects_sub: "Concrete business tools, designed to automate complex tasks and facilitate growth.",
    webapp_proj_1_title: "Student tracking platform",
    webapp_proj_1_desc: "Scheduling, MCQs, messaging, and student/tutor portals. Centralization of the entire educational experience.",
    webapp_proj_2_title: "API-connected business tool",
    webapp_proj_2_desc: "Image automation and API synchronization with the ERP to accelerate internal processes.",
    webapp_proj_3_title: "Matchmaking application",
    webapp_proj_3_desc: "Profiles, subscriptions, interactive map, and real-time notifications to connect users.",

    webapp_expertise_title: "Advanced Technical Expertise",
    webapp_expertise_sub: "Cutting-edge technologies to make your SaaS application intelligent, secure, and compliant.",
    webapp_exp_1_title: "AI Agent & Automation",
    webapp_exp_1_desc: "As an <strong>AI Agent specialist developer</strong>, I integrate Artificial Intelligence models at the heart of your SaaS (LLMs, RAG). The goal: automate your complex processes and endow your tool with advanced analysis capabilities.",
    webapp_exp_2_title: "Secure Software Architect",
    webapp_exp_2_desc: "The architecture of your web application is designed to evolve without security flaws. From user role management (RBAC) to data isolation, the technical foundation is solid from day one.",

    webapp_final_title: "Ready to test your Web App idea?",
    webapp_final_sub: "Request your free mockup and let's start building the application that will transform your business.",
    webapp_final_cta: "Get my mockup",
    // Navigation
    nav_home: "Home",
    nav_mobile: "Mobile",
    nav_saas: "SaaS",
    ...
    hero_form_step4_sub: "The more precise you are, the closer your mockup will be to your vision.",
    hero_form_step4_ph: "Ex: I want a dashboard to track my stores' sales with low stock alerts...",
    hero_form_step4_btn: "Continue",

    hero_form_nda_btn: "🔒 Request a Non-Disclosure Agreement",
    hero_form_nda_title: "Confidentiality Agreement",
    hero_form_nda_desc: "Enter your project name to generate a pre-signed NDA by Maximilien Digital.",
    hero_form_nda_ph: "Your project name",
    hero_form_nda_generate: "Download my NDA (PDF)",

    hero_form_step5_q: "Your Data & Listings (Optional)",
    hero_form_step5_sub: "Do you already have a file with your data (Excel, Google Sheets)? Paste your share link here:",
    hero_form_step5_ph: "Link to your Google Sheet, Excel file, or database...",
    ...
    hero_form_branch_q: "How do you want to present your project?",
    hero_form_branch_opt_upload: "I have a specification document (Fast)",
    hero_form_branch_opt_guide: "I want to be guided step by step",
    hero_form_upload_q: "Upload your specifications",
    hero_form_upload_sub: "Accepted formats: PDF, DOCX, XLSX (Max 100MB).",
    hero_form_upload_btn: "Choose a file",
    ...
    hero_form_step3_opt5: "Healthcare / Medical",
    hero_form_step3_opt6: "Other",
    hero_form_step3_custom_ph: "Specify your industry...",
    ...
    service_accounting_title: "Accounting & Finance",
    service_accounting_desc:
      "Dedicated solutions for accounting firms: automation, follow-ups, and tailored internal tools.",
    ...
    // Portail Client Expert Comptable
    portal_ec_tag: "Client Portal · Accounting Firms",
    portal_ec_h1: "Cut client follow-up time in half.",
    portal_ec_intro: "No more lost emails or clients forgetting their documents. Give your clients a secure, user-friendly portal to drop files, and follow up with them automatically. Designed by a finance insider, for accountants.",
    portal_ec_cta1: "Request a free mockup",
    portal_ec_li1: "Automated follow-ups for missing documents.",
    portal_ec_li2: "Simple document upload via mobile or PC.",
    portal_ec_li3: "Highly secure architecture (GDPR compliant).",
    portal_ec_li4: "Built-in client satisfaction measurement (NPS).",
    portal_ec_approach_title: "The end of the collection headache",
    portal_ec_approach_desc: "Document collection is the number one cause of margin loss for an accounting firm. By automating this step with an ultra-simple tool for your clients, your team can finally focus on review and consulting.",
    portal_ec_step1_title: "1. Centralization",
    portal_ec_step1_desc: "A single place for your clients to drop invoices, bank statements, and contracts.",
    portal_ec_step2_title: "2. Real-time tracking",
    portal_ec_step2_desc: "A dashboard for the firm to see incomplete files at a glance.",
    portal_ec_step3_title: "3. Automation",
    portal_ec_step3_desc: "Scripts send personalized reminders to late clients, with zero manual intervention.",

    // Logiciel Expert Comptable (CRM & Gestion)
    logiciel_ec_tag: "Internal Tool & CRM · Accounting Firms",
    logiciel_ec_h1: "Manage your firm, not your Excel files.",
    logiciel_ec_intro: "Engagement letters, new client onboarding, time tracking, task management... Build a custom tool connected to your production software to structure your firm's growth.",
    logiciel_ec_cta1: "Request a free mockup",
    logiciel_ec_li1: "CRM tailored to an accounting firm's sales cycle.",
    logiciel_ec_li2: "Automatic generation of engagement letters.",
    logiciel_ec_li3: "Track task progress by team member.",
    logiciel_ec_li4: "API connection with your tools (Cegid, MyUnisoft...).",
    logiciel_ec_approach_title: "Software that adapts to YOUR processes",
    logiciel_ec_approach_desc: "You shouldn't have to bend your internal processes to fit generic software. I develop the missing piece that centralizes your firm's administrative work.",
    logiciel_ec_step1_title: "1. Business framing",
    logiciel_ec_step1_desc: "Being familiar with the industry, we get straight to the point on your business needs (KYC, fees...).",
    logiciel_ec_step2_title: "2. Custom development",
    logiciel_ec_step2_desc: "A clear interface to track the status of each file and prospect.",
    logiciel_ec_step3_title: "3. Interconnection",
    logiciel_ec_step3_desc: "The internal tool communicates with your billing and accounting production.",
